...
**Project health, with figures.** Crystal lives off two sponsors: **84codes (€22,000/month since Apr 2018, ~€941,000 accumulated)** and **Manas.Tech ($5,000/month since 2009, ~$1,430,000 accumulated)**, plus Open Collective and commercial support (Crystal Compass). Recent leadership change: Beta Ziliani left the *lead* position in Sep 2025 and Johannes Müller took it. Honest reading: **a live, funded project with a team, but with a funding concentration in two companies and a small community**. It goes into the adoption decision.
